<head>
  ...
  <aside class="sidebar">
    ...
    <div>
      <a href="index.html" class="sidebar-logo">
        <img src="assets/assets/images/logo.png" alt="site logo" class="light-logo">
        <img src="assets/assets/images/logo-light.png" alt="site logo" class="dark-logo">
        <img src="assets/assets/images/logo-icon.png" alt="site logo" class="logo-icon">
      </a>
    </div>
    <div class="sidebar-menu-area">
      <ul class="sidebar-menu" id="sidebar-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="sidebar-submenu">
              <li>
                <a href="{{ route('show.investments') }}"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Show My Investments</a>
              </li>
            </ul>
        </li>
        ...
        <div class="d-flex flex-wrap align-items-center gap-3">
          ...
          <div class="dropdown">
            <button class="d-flex justify-content-center align-items-center rounded-circle" type="button" data-bs-toggle="dropdown">
              <img src="{{ asset('uploads/profile_image/'.Auth::user()->profile_image) }}" alt="image" class="w-40-px h-40-px object-fit-cover rounded-circle">
            </button>
            <div class="dropdown-menu to-top dropdown-menu-sm">
              <div class="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
                <div>
              ...
              <ul class="to-top-list">
                <li>
                  <a class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-primary d-flex align-items-center gap-3" href={{route('sadia')}}>
  ...
  <div class="my-5">
    ...
    <!-- Data Table js -->
    <script src="assets/assets/assets/js/lib/dataTables.min.js"></script>
    <!-- Iconify Font js -->
