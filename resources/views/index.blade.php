...
@section('content')
    ...
    <section class="slider-home-1 owl-carousel owl-theme">
        <div class="slides item" style="background-image: url(https://via.placeholder.com/1920x770)">
          <div class="container">
            <div class="row">
              <div class="col-lg-7">
                <div class="home-life">
            ...
            <div class="col-lg-6">
              ...
              <div class="col-8">
                <div class="help-man hoverimg">
                  <figure>
                  <img alt="man" class="w-100" src="https://via.placeholder.com/416x406">
                </figure>
              ...
              <div class="col-4">
                <div class="help-man hoverimg">
                  <img alt="man" class="helptwo" src="https://via.placeholder.com/140x140">
                  <figure>
                    <img alt="man" class="w-100 mt-4" src="https://via.placeholder.com/196x196">
                  </figure>
                </div>
              </div>
              </div>
